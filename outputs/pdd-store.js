...
const consultPrimaryText = systemSettings.consultPrimaryText || "\u7acb\u5373\u54a8\u8be2";
...
const detailConsultPrimaryLink = document.querySelector("#detailConsultPrimaryLink");
if (detailConsultLink) {
  detailConsultLink.href = `tel:${consultPhone}`;
  detailConsultLink.textContent = consultTitle;
}
if (detailConsultPrimaryLink) {
  detailConsultPrimaryLink.href = `tel:${consultPhone}`;
  detailConsultPrimaryLink.textContent = consultPrimaryText;
}
const stores = siteData.pddStores.map((raw, index) => {
  ...
  return {
    ...
    year: item.year,
    code: item.code,
    platform: item.platform || "\u62fc\u591a\u591a\u5e97",
    price: item.price || "\u54a8\u8be2\u62a5\u4ef7",
    transfer: item.transfer || "\u652f\u6301\u5e97\u94fa\u8f6c\u8ba9\u6d41\u7a0b\u5bf9\u63a5",
    assets: ["\u5e97\u94fa\u57fa\u7840\u8d44\u6599", "\u4e3b\u8425\u7c7b\u76ee\u4fe1\u606f", "\u98ce\u9669\u8bb0\u5f55\u6838\u5bf9", "\u8f6c\u8ba9\u6d41\u7a0b\u6307\u5bfc"],
    note: item.status === "\u65e0\u552e\u5047"
      ? "\u5f53\u524d\u5217\u8868\u6807\u6ce8\u4e3a\u65e0\u98ce\u9669\u8bb0\u5f55\uff0c\u5efa\u8bae\u4ea4\u6613\u524d\u518d\u6838\u5bf9\u5e97\u94fa\u540e\u53f0\u4fe1\u606f\u3002"
      : "\u5f53\u524d\u5217\u8868\u6807\u6ce8\u4e3a\u6709\u98ce\u9669\u8bb0\u5f55\uff0c\u5efa\u8bae\u5148\u54a8\u8be2\u5177\u4f53\u60c5\u51b5\u548c\u7c7b\u76ee\u9650\u5236\u3002"
  };
});
...
function renderStores() {
  storeList.innerHTML = getFilteredStores().map((store) => `
...
function renderStoreDetail(store) {
  storeModalBody.innerHTML = `
    ...
    <dl class="detail-grid">
      ...
      <div><dt>\u5e97\u94fa\u72b6\u6001</dt><dd>${store.status}</dd></div>
